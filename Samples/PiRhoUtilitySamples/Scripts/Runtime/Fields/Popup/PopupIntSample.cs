...
namespace PiRhoSoft.Utilities
{
	...
	{
		[MessageBox("The [Popup] attribute can be applied to a int to constraint the value to a list of values. Optional strings can be provided to display each value. Values and Options can be hard coded or retrieved from another field, method, or property.", MessageBoxType.Info, Location = TraitLocation.Above)]
